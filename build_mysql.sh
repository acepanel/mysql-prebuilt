...
cmake -G Ninja .. \
    ...
    -DWITH_ROCKSDB=0 \
    -DWITH_COREDUMPER=0 \
    -DDISABLE_PSI_COND=ON \
    -DDISABLE_PSI_DATA_LOCK=ON \
    -DDISABLE_PSI_ERROR=ON \
    -DDISABLE_PSI_FILE=ON \
    -DDISABLE_PSI_IDLE=ON \
    -DDISABLE_PSI_MEMORY=ON \
    -DDISABLE_PSI_METADATA=ON \
    -DDISABLE_PSI_MUTEX=ON \
    -DDISABLE_PSI_PS=ON \
    -DDISABLE_PSI_RWLOCK=ON \
    -DDISABLE_PSI_SOCKET=ON \
    -DDISABLE_PSI_SP=ON \
    -DDISABLE_PSI_STAGE=ON \
    -DDISABLE_PSI_STATEMENT=ON \
    -DDISABLE_PSI_STATEMENT_DIGEST=ON \
    -DDISABLE_PSI_TABLE=ON \
    -DDISABLE_PSI_THREAD=ON \
    -DDISABLE_PSI_TRANSACTION=ON \
